...
| ------ | -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 강민서 | Front-end/팀장 |                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| 김수환 | Front-end/서기 | - '더민트' 서비스 기획<br/>- 서비스 메인 홈페이지 베이스 제작<br/>- 카테고리 페이지 카테고리별 상품 출력 기능, 정렬기능 구현<br/>- 프로필 페이지 베이스 제작<br/>- 프로필 페이지 리뷰 카드 구현<br/>- 프로필 페이지 구매내역, 판매내역 상품 상태에 따른 출력 구현 <br/>- 상품 상태에 따라서 임급확인, 배송지 입력, 배송확인, 리뷰작성 구현<br/>- 배송조회 API를 활용하여 배송확인 구현<br/>- 팀 회의내용 일지 작성, 중요사항 달력 표시 |
| 김혜성 | Back-end/팀원  |                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| 남은열 | Front-end/팀원 |                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| 정민호 | Back-end/팀원  |                                                                                                                                                                                                                                                                                                                                                                                                                                        |
