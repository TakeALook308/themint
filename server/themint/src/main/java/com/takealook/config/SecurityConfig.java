...
import com.takealook.common.auth.MemberDetailService;
...
//    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests()
                .antMatchers("/api/keyword", "/api/keyword/{keywordName}", "api/member/my").authenticated()       //인증이 필요한 URL과 필요하지 않은 URL에 대하여 설정
